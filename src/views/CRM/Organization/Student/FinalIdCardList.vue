...
const getCardHeight = computed(() => {
  setPageSize();
  const dpi = window.devicePixelRatio * 192/2;
  const mmToInch = 25.4;
      ...
      <div>
        <div
          style="
            ...
            transform: translate(${convertPxTo96Dpi(element.props.left)}px, ${convertPxTo96Dpi(element.props.top)}px) ${element.rotate};
            z-index: auto;
            user-select: auto;
