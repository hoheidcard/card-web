  ...
  <section class="user-activity user-profile">
    <div class="table-card">
      ...
      <div class="download-body">
        <div
          class="body-item"
          v-for="(item, index) in storeVar.csvData"
          :key="index"
        >
          <div class="data">
...
/* Functions/Methods */
function addSubject() {
  storeVar.value.csvData.forEach((element) => {
  ...
  store.dispatch("OrganizationSettings/updateCsvField", {
    ...
    csvFields: JSON.stringify(formVar.fields),
    staffCsvFields: storeVar.value.staffCsvFields,
  });
  storeVar.value.studentCsvFields = JSON.stringify(formVar.fields);
  formVar.fields = [];
}
