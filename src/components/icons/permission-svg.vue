<template>
  <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 32 32" viewBox="0 0 32 32" id="icon">
    <path d="M18,11c0-1.1-0.9-2-2-2s-2,0.9-2,2v2h4V11z"></path>
  ...
  <path d="M16,16c-0.6,0-1,0.4-1,1v2c0,0.6,0.4,1,1,1s1-0.4,1-1v-2C17,16.4,16.6,16,16,16z"></path>
</svg>
</template>