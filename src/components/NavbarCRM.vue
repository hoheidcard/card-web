    ...
    <div class="navbar-container">
      <div class="top-line">
        <div id="scroll-container">
          <div id="scroll-text">
            <span id="sc-text"> Welcome to Id Mitra. 🎉 </span> &nbsp;
      ...
      <div class="nav-wrapper">
        <div class="container">
          <div class="nav-left">
            ...
            <router-link
              :to="`/crm/dashboard?id=${formVar.id}&settingId=${formVar.settingId}`"
              class="logo mob-logo"
            >
          ...
          <div class="nav-icons">
            ...
            <div v-if="formVar.roles === 'SCHOOL'">
              <router-link
                :to="`/crm/organization/setting/class-list?id=${formVar.id}&settingId=${formVar.settingId}`"
                class="nav-icon"
              >
            ...
            <div v-else>
              <router-link
                :to="`/crm/organization-staff-profile?id=${formVar.staffId}&settingId=${formVar.settingId}`"
                class="nav-icon"
              >
                <div class="icon tooltip-wrapper">
                  <icon-user></icon-user>
