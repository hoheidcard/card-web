...
export const getOneOrganizationSettings = async ({ commit, dispatch }, { id }) => {
...
/****** CLASS ******/
export const addClass = async ({ commit, state }, { name, priority, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
export const updateClass = async ({ commit, state }, { id, name, priority, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
/****** END CLASS ******/
/****** DIVISION ******/
export const addDivision = async ({ commit, state }, { name, priority, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
export const updateDivision = async ({ commit, state }, { id, name, priority, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
/****** END DIVISION ******/
/****** BOOK CATEGORY ******/
export const addBookCategory = async ({ commit, state }, { name, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
export const updateBookCategory = async ({ commit, state }, { id, name, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
export const updateDepartment = async ({ commit, state }, { id, name, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
/****** DESIGNATION ******/
export const addDesignation = async ({ commit, state }, { name, priority, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
export const updateDesignation = async ({ commit, state }, { id, name, priority, settingId }) => {
	commit("SET_LOADER", true, { root: true });
	await apiServices.updateDesignationByAdmin(id, name, priority, settingId).then(
		(response) => {
			state.addModal = false
			commit("SET_LOADER", false, { root: true });
...
export const updateHouseZone = async ({ commit, state }, { id, name, settingId }) => {
	commit("SET_LOADER", true, { root: true });
...
export const updateSubject = async ({ commit, state }, { id, name, settingId }) => {
	commit("SET_LOADER", true, { root: true });
